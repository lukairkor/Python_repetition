...
class Engine:
    ...
    def describe_engin(self):
        print("Engine type is ", self.engin_type, " and its power is equal to", self.engin_power)


class Aircraft(Engine):
    def __init__(self, type_name, model_name): # example of magic method with __init__
        self.type_name = type_name
        self.model_name = model_name
        
    def name_of_aircraft(self):
        print("Aircraft name is ", self.type_name, "and model name is ", self.model_name)
