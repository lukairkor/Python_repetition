...
- first node of a list is called Head
- last is called Tail points to Null
...
class Node:
    ...
    def __init__(self, data):
        ...
        self.next = None  # hold reference to the next node
...
class LinkedList:
    ...
    def add_back(self, data):
        ...
        if self.head is None:  # check if a list is empty
            self.head = new_node  # set the first node
        else:
    ...
    def del_front(self):
        """add an element at a list front"""
    ...
    def del_end(self):
        """delete element from a list end"""
        if self.head is None:
            print("empty list")
            return
